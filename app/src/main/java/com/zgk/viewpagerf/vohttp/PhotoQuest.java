...
import com.zgk.viewpagerf.MyActivitys.MapActivity;
...
public class PhotoQuest {
    ...
    public void NewsRequest(final Context context,final RecyclerView newsRV) {
        //请求地址
        String url = "http://xxxxxxxxxx/WebApplication1/SceneryServlet";    //注①
        String tag = "News";    //注②
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            adapter = new SceneryAdapter(R.layout.scenery_item,newsInfos);
                            //条目点击事件
                            adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                                @Override
                                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                                    ConfirmDialog confirmDialog = new ConfirmDialog(context);
                                    confirmDialog.setLogoImg(R.mipmap.dialog_notice).setMsg("是否打开校园地图？");
