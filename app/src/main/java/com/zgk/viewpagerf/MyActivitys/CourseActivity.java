...
import static com.orient.me.widget.sw.MultiSwitch.TAG;

public class CourseActivity extends Activity {
    private List<CourseModel> mCourse;
    ...
    private void initCtrl() {
        ...
        mFirday = (LinearLayout) findViewById(R.id.friday);
        mSaturday = (LinearLayout) findViewById(R.id.saturday);
        mWeekend = (LinearLayout) findViewById(R.id.sunday);
    }
    ...
    private void drawCourse(LinearLayout ll, char dayOfWeek) {
        ...
        // 上一节课结束是第几节
        int perCourse = -1;
        for (CourseModel course : mCourse) {//遍历
            // 判断是否显示这节课
            // 是不是同一天 是不是这一周
            ...
            tv.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    CourseModel tag = (CourseModel) v.getTag();
    ...
    private void drawAllCourse() {
        drawCourse(mMonday, '1');
        drawCourse(mTuesday, '2');
        drawCourse(mWednesday, '3');
        drawCourse(mThursday, '4');
        drawCourse(mFirday, '5');
        drawCourse(mSaturday, '6');
        drawCourse(mWeekend, '7');
    }
    ...
    private void readIniFile() {
        ...
        mNowWeek= Integer.parseInt(getIntent().getStringExtra("ZC"));
        mMaxCouese = mShaerPreferences.getInt("mMaxCouese", 12);
        mMaxWeek = mShaerPreferences.getInt("mMaxWeek", 20);
    ...
    private void praseJson() {
        ...
        mCourse= (List<CourseModel>) getIntent().getSerializableExtra("userlist");
    }
